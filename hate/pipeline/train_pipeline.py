...
class TrainPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifacts) -> DataValidationArtifacts:
        logging.info("Entered the start_data_validation method of TrainPipeline class")
        try:
            logging.info("Validating the data from GCLoud Storage bucket")
            data_validation = DataValidation(data_ingestion_artifact=data_ingestion_artifacts, 
                                             data_validation_config=self.data_validation_config)

            data_validation_artifacts = data_validation.initiate_data_validation()
            logging.info("Successfully validated the data from GCLoud Storage bucket")
