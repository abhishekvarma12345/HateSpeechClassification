...
class DataValidationConfig:
    def __init__(self):
        self.IMBALANCE_DATA_COLUMNS = IMBALANCED_DATA_SCHEMA["columns"]
        self.IMBALANCE_DATA_COLUMN_NAMES = IMBALANCED_DATA_SCHEMA["column_names"]
        self.RAW_DATA_COLUMNS = RAW_DATA_SCHEMA["columns"]
        self.RAW_DATA_COLUMN_NAMES = RAW_DATA_SCHEMA["column_names"]
